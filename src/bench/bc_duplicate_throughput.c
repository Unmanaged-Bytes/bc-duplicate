...
static int bc_duplicate_throughput_compare_double(const void* left, const void* right)
{
...
{
    qsort(samples, sample_count, sizeof(double), bc_duplicate_throughput_compare_double);
