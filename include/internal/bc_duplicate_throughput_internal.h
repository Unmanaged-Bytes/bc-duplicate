...
#ifndef BC_DUPLICATE_THROUGHPUT_INTERNAL_H
#define BC_DUPLICATE_THROUGHPUT_INTERNAL_H
...
typedef struct bc_duplicate_throughput_constants {
    double xxh3_gigabytes_per_second;
    double xxh128_gigabytes_per_second;
...
} bc_duplicate_throughput_constants_t;
...
#endif /* BC_DUPLICATE_THROUGHPUT_INTERNAL_H */
